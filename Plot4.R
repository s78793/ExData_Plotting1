...
plot(subset_file$Time, subset_file$Voltage, xlab = "", ylab = "Voltage", type = "l")
...
plot(subset_file$Time, subset_file$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
